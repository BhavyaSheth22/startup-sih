		...
		return (
			<React.Fragment>
				...
				<div css={wrapperStyle()}>
					...
					<div css={userWrapperStyle()} onClick={() => this.createUser()}>
						<div css={thumbnailWrapperStyle()}>
							<CometChatAvatar image="https://data-us.cometchat.io/assets/images/avatars/ironman.png" />
						</div>
						<p>Create User</p>
					</div>
					<div css={userWrapperStyle()} onClick={() => this.login("Aditya")}>
						<div css={thumbnailWrapperStyle()}>
							<CometChatAvatar image="https://data-us.cometchat.io/assets/images/avatars/ironman.png" />
						</div>
						<p>Adi</p>
					</div>
					<div css={userWrapperStyle()} onClick={() => this.login("Yash")}>
						<div css={thumbnailWrapperStyle()}>
							<CometChatAvatar image="https://data-us.cometchat.io/assets/images/avatars/ironman.png" />
						</div>
						<p>Yash</p>
